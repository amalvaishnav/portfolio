...
export const identity = {
  ...
  tagline:
    "I build friendly, careful interfaces for the web, then go play pickleball.",
  bio: [
    ...
    "Off the clock, the gym is my meditation: a few heavy sets and everything goes quiet. The rest of my energy goes into volleyball, pickleball, cricket and soccer, and into pulling up a chair for a board game.",
  ],
};
...
export const experience = [
  ...
  },
  {
    ...
    location: "Cary, NC",
    roles: [
      { title: "Software Engineer Intern", start: "Jun 2019", end: "Nov 2019" },
    ],
    bullets: [
  ...
  },
  {
    ...
    location: "Greater Ahmedabad area",
    roles: [
      { title: "Data Mining Intern", start: "May 2017", end: "Aug 2017" },
    ],
    bullets: [
...
export const skills = [
  ...
  },
  {
    ...
    items: ["Agile", "JIRA", "Bitbucket", "SwaggerUI"],
  },
];
